"""Extractor that relies on a tool by Jonathan Reeve to chapterize Project Gutenberg texts. https://github.com/JonathanReeve/chapterize."""

# from chapterize.chapterize import Book, Chapter, chapterize
...
class ChapterDetectionError(Exception):
    """Exception raised when chapters cannot be detected properly."""
...
class Book:
    ...
    def contents(self):
        ...
        """
        return GutenbergExtractor.clean_soup(self.soup.get_text())
